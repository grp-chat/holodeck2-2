...
class GridSystem {
    constructor() {
        ...
        this.team1OriginPosition = [
            {x:29, y:8, area: "area1"},
            {x:29, y:9, area: "area1"},
            {x:29, y:10, area: "area1"},
            {x:29, y:11, area: "area1"},
            {x:29, y:12, area: "area1"},
            {x:29, y:13, area: "area1"},
        ];
        this.team2OriginPosition = [
            {x:11, y:8, area: "area1"},
            {x:11, y:9, area: "area1"},
            {x:11, y:10, area: "area1"},
            {x:11, y:11, area: "area1"},
            {x:11, y:12, area: "area1"},
        ];
        ...
        this.playersArr = [
            this.p1 = new Player({x: 23, y: 7, lable: 2, id: this.extraArr[0], area: "area1", color: "grey", startingSteps: 500}),

            this.p2 = new Player({x: 23, y: 8, lable: 3, id: this.extraArr[1], area: "area1", color: "springgreen"}),
            this.p3 = new Player({x: 23, y: 9, lable: 4, id: this.extraArr[2], area: "area1", color: "orange"}),
            this.p4 = new Player({x: 23, y: 11, lable: 5, id: this.extraArr[3], area: "area1", color: "lightblue"}),
            this.p5 = new Player({x: 23, y: 12, lable: 6, id: this.extraArr[4], area: "area1", color: "moccasin"}),
            this.p6 = new Player({x: 23, y: 13, lable: 7, id: this.extraArr[5], area: "area1", color: "deepskyblue"}),
            this.p7 = new Player({x: 24, y: 7, lable: 8, id: this.extraArr[6], area: "area1", color: "white"}),
            this.p8 = new Player({x: 24, y: 8, lable: 9, id: this.extraArr[7], area: "area1", color: "hotpink"}),
            this.p9 = new Player({x: 24, y: 9, lable: 10, id: this.extraArr[8], area: "area1", color: "teal"}),
            this.p10 = new Player({x: 24, y: 12, lable: 11, id: this.extraArr[9], area: "area1", color: "yellow"}),
            this.p11 = new Player({x: 24, y: 13, lable: 12, id: this.extraArr[10], area: "area1", color: "turquoise"})
        ];
    ...
    translocator(plyrSlot) {
        ...
        this.matrix[3][3] = plyrSlot.lable;
        plyrSlot.x  = 3
        plyrSlot.y = 3;
